...
import com.zhiku.elearning.entity.mysql.SpecialColumn;
...
import com.zhiku.elearning.service.SpecialColumnService;
...
public class SpecialColumnArticleAdminController {
    ...
    public JSONObject deleteBatch(@RequestParam(value = "ids") String ids) throws Exception {
        ...
        int count = 0;
        for (String s : idsStr) {
            int res = specialColumnArticleService.delete(Integer.parseInt(s));
            count += res;
        }
        result.put("code", 200);
