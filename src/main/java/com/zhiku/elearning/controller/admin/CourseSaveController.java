package com.zhiku.elearning.controller.admin;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.zhiku.elearning.service.CourseSaveService;
...
public class CourseSaveController {
        ...
        if (!StringUtils.isEmpty(seqs)) {
            try {
                ...
                for (int i = 0; i < jsonArray.size(); i++) {
                    ...
                    ChapterProgressView chapterProgressView = new
                            ChapterProgressView();
    ...
    public ResponseData delete(Integer cid, String vid, String seqs) {
        List<
                ChapterProgressView> chapterProgressViews = null;
        //转换seqs
        if (seqs != null) {
            try {
                chapterProgressViews = new ArrayList<>();
    ...
    public ResponseData preview(MultipartFile file) {
        ...
        Map<String,
                SectionContentView> sectionViewMap = new HashMap<>();
