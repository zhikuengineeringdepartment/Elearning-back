...
import com.zhiku.elearning.mapper.CollectParagraphMapper;
...
//    ParagraphMapper paragraphMapper;
    @Autowired
    CollectParagraphMapper collectParagraphMapper;
    @Autowired
     ...
     * @return 一个收藏段落的列表
     */
    public List<CollectParagraphSectionView> getColParagraphs(int uid, int sid) {
        return collectParagraphMapper.selectBySid(uid, sid);
    }
     ...
     * @return 收藏段落列表
     */
    public List<CollectParagraphView> getColParagraphViews(Integer uid, Integer cid, Integer ordtime, Integer page, Integer pagesize) {
//        return colParagraphMapper.selectParagraphView(uid);
        return collectParagraphMapper.selectParagraphViewByWhere(uid, cid, ordtime, page, pagesize);
    }
...
//        colParagraph.setParagraphId(paragraph.getPid());
//        colParagraph.setCollectUser(uid);
//        colParagraph.setDate(new Date());
...
//        ParagraphMysql paragraph = paragraphMapper.selectByParagraphSeq(paragraphSeq);
//        colParagraphKey.setCollectUser(uid);
//        colParagraphKey.setParagraphId(paragraph.getPid());
